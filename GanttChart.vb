...
Public Class GanttChart
    ...
    Private dateTextFont As Font = New Font("微軟正黑體", 8.0, FontStyle.Regular, GraphicsUnit.Point)
    Private timeTextFont As Font = New Font("微軟正黑體", 8.0, FontStyle.Regular, GraphicsUnit.Point)
    Private rowTextFont As Font = New Font("微軟正黑體", 8.0, FontStyle.Regular, GraphicsUnit.Point)
    ...
    Private Sub DrawHeader(ByVal gfx As Graphics, ByVal headerList As List(Of Header))
        ...
        For Each header As Header In headerList
            ...
            If showDateHeader = True Then
                ...
                gfx.DrawString(header.Time.ToString("%M/%d"), dateTextFont, Brushes.Black, startPos, 0)
            End If
