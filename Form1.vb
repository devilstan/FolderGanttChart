...
Public Class Form1
            ...
            Try
                ...
                Else
                    ...
                    If xNodeTemp2.Count > 1 Then
                        ...
                        Dim tdate2 As Date = "#" & CType(xNodeTemp2.Item(xNodeTemp2.Count - 2), XmlElement).GetAttribute("time") & "#"
                        If tdate.ToString("yyyy.MM.dd HH") = filesinfo(0).ToString("yyyy.MM.dd HH") Then
                    ...
                    ElseIf xNodeTemp2.Count = 1 Then
                        Dim tdate As Date = "#" & CType(xNodeTemp2.Item(xNodeTemp2.Count - 1), XmlElement).GetAttribute("time") & "#"
                        If tdate.ToString("yyyy.MM.dd HH") = filesinfo(0).ToString("yyyy.MM.dd HH") Then
                            xNodeTemp.RemoveChild(xNodeTemp2.Item(xNodeTemp2.Count - 1))
                        End If
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        NotifyIcon1.BalloonTipTitle = "更新通知 (刪除則不列出)"
        NotifyIcon1.BalloonTipText = "資料夾" & "『" & folder_changed_now & "』" & "變動, 清單如下" & vbCrLf & recentList
