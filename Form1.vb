Public Class Form1
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        With GanttChart1
            ...
            lst.Add(New BarInformation("程式碼維護", New Date(2014, 12, 12), New Date(2014, 12, 16), Color.Aqua, Color.Khaki, 0))
            lst.Add(New BarInformation("制御仕樣書", New Date(2014, 12, 13), New Date(2014, 12, 20), Color.AliceBlue, Color.Khaki, 1))
            lst.Add(New BarInformation("測試仕樣書", New Date(2014, 12, 14), New Date(2014, 12, 24), Color.Violet, Color.Khaki, 2))
            lst.Add(New BarInformation("檢核", New Date(2014, 12, 21), New Date(2014, 12, 22, 12, 0, 0), Color.Yellow, Color.Khaki, 3))
            lst.Add(New BarInformation("會議記錄", New Date(2014, 12, 17), New Date(2014, 12, 24), Color.LawnGreen, Color.Khaki, 4))
